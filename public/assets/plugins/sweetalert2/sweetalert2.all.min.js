!function (e, t) {
    ...
    const mt = ["swal-title", "swal-html", "swal-footer"], ht = e => {
            ...
            Et(t, n, e), setTimeout(() => {
                xt(t, n)
            }, 10), I() && (Pt(t, e.scrollbarPadding, o), (() => {
                const e = a(document.body.children);
                e.forEach(e => {
        ...
        Lt = e => e.files.length ? null !== e.getAttribute("multiple") ? e.files : e.files[0] : null, Ot = (t, n) => {
            const o = v(), i = e => Dt[n.input](o, Mt(e), n);
        ...
        }, It = (e, t) => t && t.toString() === e.toString(), Ht = (e, t) => {
            ...
            n.inputValidator ? qt(e, o, t) : e.getInput().checkValidity() ? ("deny" === t ? Vt : Ut)(e, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        }, qt = (t, n, o) => {
            const e = he.innerParams.get(t);
            t.disableInput();
            const i = Promise.resolve().then(() => d(e.inputValidator(n, e.validationMessage)));
            i.then(e => {
                t.enableButtons(), t.enableInput(), e ? t.showValidationMessage(e) : ("deny" === o ? Vt : Ut)(t, n)
            })
        }, Vt = (t, n) => {
    ...
    }), rn.DismissReason = l, rn.version = "11.1.0";
    const cn = rn;
